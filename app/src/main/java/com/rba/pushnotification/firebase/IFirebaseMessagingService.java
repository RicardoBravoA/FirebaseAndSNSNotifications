...
public class IFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        Log.d("x- json2", new Gson().toJson(remoteMessage.getData().get(Constant.PUSH_DISCOUNT)));
        Log.d("x- json3", new Gson().toJson(remoteMessage.getData().get(Constant.PUSH_DATE)));
        Log.d("x- json4", new Gson().toJson(remoteMessage.getNotification().getTitle()));
        Log.d("x- json5", new Gson().toJson(remoteMessage.getNotification().getBody()));
